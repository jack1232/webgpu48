...
export const CreateChartWithTexture = async (vertexData: Float32Array, normalData: Float32Array, uvData: Float32Array, 
    colorData:Float32Array, textureFile:string, isAnimation = true) => {
